...
async def main():
    async with bot:
        ...
        try:
            await USER.join_chat("amanrajput")
...
bot.run(main())
bot.start()
print("\n\nRadio Player Bot Started, follow  @itsamanrajput!")
bot.send(
...
async def restart(_, message: Message):
    ...
    try:
        await k.edit("✅ **Restarted Successfully! \ncontact its amanrajput  For Update!**")
        await k.reply_to_message.delete()
    except:
        pass

idle()
print("\n\nRadio Player Bot Stopped, contact its amanrajput!")
bot.stop()
